 ...
 */
namespace Commercers\Profilers\Model\Condition;
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \Commercers\Profilers\Model\Condition\ProductFactory $conditionFactory,
        array $data = [],
        array $excludedAttributes = []
    ) {
        $this->productFactory = $conditionFactory;
        parent::__construct($context, $data);
        $this->setType(\Commercers\Profilers\Model\Condition\Combine::class);
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive(
            ...
            [
                [
                    'value' => \Commercers\Profilers\Model\Condition\Combine::class,
