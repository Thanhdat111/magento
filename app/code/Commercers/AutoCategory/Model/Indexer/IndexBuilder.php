 ...
 */
namespace Commercers\AutoCategory\Model\Indexer;
...
use Commercers\AutoCategory\Model\ResourceModel\Rule\CollectionFactory as RuleCollectionFactory;
    ...
    public function reindexByIds(array $ids)
    {
        try {
            ...
            throw new LocalizedException(
                __("Auto category rule indexing failed. See details in exception log.")
            );
        }
    }
