...
namespace Commercers\AutoCategory\Model;
...
use Commercers\AutoCategory\Model\Rule\Condition\CombineFactory;
...
class Rule extends AbstractModel implements IdentityInterface
{
     ...
     * Constants cache tag
     */
        const CACHE_TAG = 'COMMERCERS_AUTOCATEGORY_RULE';
     ...
     * @var string
     */
    protected $_eventPrefix = 'commercers_autocategory_rule';
    ...
    public function getMatchingProductIds()
    {
        if ($this->productIds === null) {
            ...
            $this->_eventManager->dispatch(
                'commercers_autocategory_product_collection_match_before',
    ...
    {
        if ($dataObject->getIsEnable()) {
            $validator = new DataObject(['error' => null, 'continue' => true]);
            $this->_eventManager->dispatch(
                'commercers_autocategory_validate_data',
