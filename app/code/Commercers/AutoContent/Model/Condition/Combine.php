 ...
 */
namespace Commercers\AutoContent\Model\Condition;
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \Commercers\AutoContent\Model\Condition\ProductFactory $conditionFactory,
        array $data = [],
        array $excludedAttributes = []
    ) {
        $this->productFactory = $conditionFactory;
        parent::__construct($context, $data);
        $this->setType(\Commercers\AutoContent\Model\Condition\Combine::class);
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive(
            ...
            [
                [
                    'value' => \Commercers\AutoContent\Model\Condition\Combine::class,
