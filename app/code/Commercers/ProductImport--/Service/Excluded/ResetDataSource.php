...
class ResetDataSource {
    ...
    public function __construct(
            ...
            \Magento\CatalogInventory\Api\StockRegistryInterfaceFactory $stockRegistry,
            \Magento\Framework\Event\ManagerInterface $eventManager,
            \Magento\CatalogInventory\Model\ResourceModel\Stock\Item\CollectionFactory $stockItemFactory,
    ...
    protected function updateStockItem($productId, $qty){
        $this->_eventManager->dispatch(
            ...
            ['item' => $this->_getStockItemByProductId($productId)]
        );
        $updateStockSql = "
    ...
    protected function _getStockItemByProductId($productId){
        return  $this->stockRegistry->create()->getStockItem($productId);
