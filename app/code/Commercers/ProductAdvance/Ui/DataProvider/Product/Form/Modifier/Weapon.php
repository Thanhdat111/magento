...
class Weapon extends AbstractModifier
{
    /**
     * @var ArrayManager
     */
    ...
    {
        $attributeCode = 'begadi_mpd_waffe';
                ...
                'children'  => [
                    $attributeCode => [
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'component' => 'Commercers_ProductAdvance/js/form/components/weapon',
                                    'componentType' => Field::NAME,
                                    'formElement' => Input::NAME,
//                                    'filterUrl'     => $this->_urlBuilder->getUrl(
//                                        'product_advance/product/ajaxGetWeapon',
//                                        ['isAjax' => 'true']
//                                    ),
                                    'config' => [
