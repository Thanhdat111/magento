...
class Size extends AbstractModifier
{
    /**
     * @var ArrayManager
     */
    ...
    {
        $attributeCode = 'begadi_mpd_groesse';
                ...
                'children'  => [
                    $attributeCode => [
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'component' => 'Commercers_ProductAdvance/js/form/components/size',
                                    'componentType' => Field::NAME,
                                    'formElement' => Input::NAME,
                                    'filterUrl'     => $this->_urlBuilder->getUrl(
                                        'product_advance/product/ajaxGetSize',
                                        ['isAjax' => 'true']
                                    ),
                                    'config' => [
