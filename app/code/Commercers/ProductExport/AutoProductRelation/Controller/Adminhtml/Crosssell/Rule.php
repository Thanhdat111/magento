...
abstract class Rule extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Commercers_AutoProductRelation::backend')
            ->_addBreadcrumb(__('Crosssell AutoProductRelation'), __('Crosssell AutoProductRelation'));
        return $this;
    }
    ...
    {
        return $this->_authorization->isAllowed('Commercers_AutoProductRelation::rules');
    }
}