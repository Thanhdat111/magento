...
class Save extends \Commercers\AutoProductRelation\Controller\Adminhtml\Crosssell\Rule
{
    ...
    public function execute()
    {
        ...
        try {
           ...
           //echo "<pre>";print_r($this->getRequest()->getPostValue());echo "<pre>";exit;
            ...
            $this->_session->setPageData($data);
            $this->_redirect('backend/*/edit', ['id' => $this->getRequest()->getParam('rule_id')]);
            return;
        }
    }
    ...
    protected function prepareData($data)
    {
        ...
        if (isset($data['parameters']['conditions'])) {
            $data['conditions'] = $data['parameters']['conditions'];
        }
